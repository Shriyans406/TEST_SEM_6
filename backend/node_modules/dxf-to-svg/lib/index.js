...
const headerHandler = require('./handlers/header').header;
const tablesHandler = require('./handlers/tables').tables;
const blocksHandler = require('./handlers/blocks').block;
const entitiesHandler = require('./handlers/entities').entities;
...
export const toSVG = require('./toSVG').toSVG;
